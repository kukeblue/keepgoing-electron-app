...
export const doGetWatuClickMap = (deviceId: number, mapName: string, x: number, y: number, index:number) => (window as any).ipcRenderer.sendSync(resourcePaths.METHOD_CLICK_WATU_MAP, [deviceId, mapName, x, y, index])
