...
export const doTest = (userid: string, maxBaotu: number, tieLevels: string[], shuLevels: string[], isChiHong: boolean, isChilan: boolean, finishTodo: number) => (window as any).ipcRenderer.sendSync(resourcePaths.METHOD_TEST, [
    userid, maxBaotu, tieLevels.toString() || 0, shuLevels.toString() || 0, isChiHong, isChilan, finishTodo
])
